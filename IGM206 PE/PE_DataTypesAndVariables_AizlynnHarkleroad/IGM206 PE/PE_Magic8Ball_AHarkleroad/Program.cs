    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                switch (action)
                {
                    // asks the 8 ball a question using ShakeBall(), and prints the response
                    case "shake":
                        ...
                        Console.WriteLine();
                        break;
                    // prints how many times the given 8 ball has been asked a question
                    case "report":
                        Console.WriteLine(magicEightBall.Report());
                        Console.WriteLine();
                        break;
                    // prints a goodbye and ends the program/loop
                    case "quit":
